...
export const adminService = {
  ...
  uploadPackageImages:   (id, formData) => api.post(`/admin/packages/${id}/images`, formData, { headers: { 'Content-Type': 'multipart/form-data' } }),
  deletePackageImage:    (id, imageUrl) => api.delete(`/admin/packages/${id}/images`, { data: { imageUrl } }),
  uploadItineraryImages: (id, formData) => api.post(`/admin/itineraries/${id}/images`, formData, { headers: { 'Content-Type': 'multipart/form-data' } }),
  deleteItineraryImage:  (id, imageUrl) => api.delete(`/admin/itineraries/${id}/images`, { data: { imageUrl } }),
  ...
  uploadDestinationImages: (id, formData) => api.post(`/admin/destinations/${id}/images`, formData, { headers: { 'Content-Type': 'multipart/form-data' } }),
  deleteDestinationImage:  (id, imageUrl) => api.delete(`/admin/destinations/${id}/images`, { data: { imageUrl } }),
  ...
  uploadFestivalImages:  (id, formData) => api.post(`/admin/festivals/${id}/images`, formData, { headers: { 'Content-Type': 'multipart/form-data' } }),
  deleteFestivalImage:   (id, imageUrl) => api.delete(`/admin/festivals/${id}/images`, { data: { imageUrl } }),
  ...
  uploadAboutImages:     (id, formData) => api.post(`/admin/about/${id}/images`, formData, { headers: { 'Content-Type': 'multipart/form-data' } }),
  deleteAboutImage:      (id, imageUrl) => api.delete(`/admin/about/${id}/images`, { data: { imageUrl } }),
