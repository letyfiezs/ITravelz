        ...
        <div className={styles.actions}>
          ...
          <div className={styles.langMenu} ref={langRef}>
            ...
            >
              ...
              <i
                className={`fas fa-chevron-down ${styles.langChevron} ${langOpen ? styles.langChevronOpen : ""}`}
              />
            </button>
            {langOpen && (
          ...
          {user ? (
              ...
              {dropOpen && (
                <div className={styles.dropdown}>
                  ...
                  <Link to="/profile" className={styles.dropItem}>
                    <i className="fas fa-user" /> {t("nav_profile")}
                  </Link>
                  <Link to="/bookings" className={styles.dropItem}>
                    <i className="fas fa-ticket-alt" /> {t("nav_bookings")}
                  </Link>
                  {user.role === "admin" && (
                    <Link to="/admin" className={styles.dropItem}>
                      <i className="fas fa-shield-alt" /> {t("nav_admin")}
                    </Link>
                  )}
                  <div className={styles.dropDivider} />
                  <button
            ...
            <div className={styles.authBtns}>
              ...
              <Link
                to="/signup"
                className={`btn btn-primary btn-sm ${styles.registerBtn}`}
              >
                {t("nav_register")}
              </Link>
            </div>
