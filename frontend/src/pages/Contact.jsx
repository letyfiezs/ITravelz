...
const CONTACT_INFO = {
  emails: [
    ...
    "sales@itravelmongolia.com",
    "booking@itravelmongolia.com",
  ],
  phone: "+976 77088055",
  hours: "Everyday 24/7",
  address:
    "Chingeltei district, 20th khoroo, Khuvisgalchid Street, Sky Hotel building room 105, Ulaanbaatar city, Mongolia",
};
...
const FAQS = [
  {
    ...
    a: "We recommend booking at least 4–6 weeks before your travel date for the best availability and pricing.",
  },
  {
    q: "Do you offer travel insurance?",
    a: "Yes, all our packages include basic travel insurance. Comprehensive coverage can be added during booking.",
  },
  {
    q: "Can I customize a package?",
    a: "Absolutely! Every package can be tailored to your preferences, budget, and schedule. Contact us to get started.",
  },
  {
    q: "What payment methods do you accept?",
    a: "We accept all major credit cards, PayPal, bank transfers, and installment plans for bookings over $1,000.",
  },
];
        ...
        <div className="container">
          ...
          <div className={styles.faqs}>
            {FAQS.map(({ q, a }, i) => (
              <div
                key={i}
                className={`${styles.faq} ${openFaq === i ? styles.faqOpen : ""}`}
              >
                <button
