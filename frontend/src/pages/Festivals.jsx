...
const FALLBACK = [
  {
    ...
    category: "naadam",
    description:
      'The grandest national festival of Mongolia featuring the "Three Games of Men" — wrestling, horse racing, and archery.',
    images: [
      "https://images.unsplash.com/photo-1596797043736-67b14e7e3360?w=600&q=80",
    ],
  },
  {
    ...
    category: "culture",
    description:
      "Mongolian Lunar New Year — a time of family reunion, traditional feasts, and the gifting of fermented mare's milk.",
    images: [
  ...
  },
  {
    ...
    category: "culture",
    description:
      "Kazakh eagle hunters showcase centuries-old traditions of falconry in the breathtaking Altai mountains.",
    images: [
  ...
  },
  {
    ...
    category: "winter",
    description:
      "Celebrate the frozen Khövsgöl lake with ice sculptures, reindeer sledding, and shamanic ceremonies.",
    images: [
      "https://images.unsplash.com/photo-1547369093-8a7e27cf5fd6?w=600&q=80",
    ],
  },
];
    ...
    <div className={styles.rmBackdrop} onClick={handleBackdrop}>
      <div className={styles.rmContent}>
        ...
        <div className={styles.rmImgWrap}>
          ...
          {fest.category && (
            <span
              className={`${styles.catBadge} ${styles["cat_" + fest.category] || ""}`}
            >
              <i className={CATEGORY_ICONS[fest.category] || "fas fa-star"} />{" "}
              {fest.category}
            </span>
          )}
        </div>
...
export default function Festivals() {
  ...
  const tr = (fest, key) =>
    fest.translations?.[language]?.[key] || fest[key] || "";
                    ...
                    <div className={styles.cardImgOverlay}>
                      {fest.category && (
                        ...
                        >
                          <i
                            className={
                              CATEGORY_ICONS[fest.category] || "fas fa-star"
                            }
                          />{" "}
                          {fest.category}
                        </span>
                  ...
                  <div className={styles.cardBody}>
                    ...
                    {tr(fest, "description") && (
                      <p className={styles.cardDesc}>
                        {tr(fest, "description").slice(0, 100)}
                        {tr(fest, "description").length > 100 ? "…" : ""}
                      </p>
                    )}
