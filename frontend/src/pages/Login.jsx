      ...
      <div className={styles.authLeft}>
        <div className={styles.authLeftContent}>
          ...
          <ul className={styles.authFeatures}>
            <li>
              <i className="fas fa-check-circle" /> 120+ handpicked destinations
            </li>
            <li>
              <i className="fas fa-check-circle" /> Secure and transparent
              pricing
            </li>
            <li>
              <i className="fas fa-check-circle" /> 24/7 travel support
            </li>
          </ul>
        </div>
          ...
          {unverifiedEmail && (
            ...
            >
              ...
              {resendStatus === "sent" ? (
                ...
                >
                  <i className="fas fa-check-circle" /> Verification email sent!
                  Check your inbox.
                </span>
              ) : (
                <button
              ...
              {resendStatus === "error" && (
                <span
                  style={{ color: "var(--error, red)", fontSize: "0.85rem" }}
                >
